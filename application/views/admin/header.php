...
<html>
<head>
	<title>Dashboard - Shoe Store</title>
	...
	<nav class="navbar navbar-default">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo base_url().'admin'; ?>">Sepatu</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-examplenavbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li><a href="<?php echo base_url().'sepatu'; ?>"><span class="glyphicon glyphicon-folder-open"></span> Data Sepatu</a></li>
					<li><a href="<?php echo base_url().'anggota'; ?>"><span class="glyphicon glyphicon-user"></span> Data Anggota</a></li>
					<li><a href="<?php echo base_url().'pembelian'; ?>"><span class="glyphicon glyphicon-sort"></span> Transaksi Pembelian</a></li>
