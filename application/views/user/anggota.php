                    ...
                    foreach ($anggota as $a) { ?>
                        <tr>
                            ...
                            <!--<td>
                                        ...
                                        <a href="<?
                                                    ?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul . ' ' . $b['nama_sepatu']; ?> ?');" class="badge badge-danger"><i class="fas fa-trash"></i> Hapus</a>
                                    </td> -->
                        </tr>
                    <?php } ?>
                </tbody>
...
<div class="modal fade" id="sepatuBaruModal" tabindex="-1" role="dialog" aria-labelledby="sepatuBaruModalLabel" aria-hidden="true">
            ...
            <form action="<?= base_url('sepatu'); ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="nama_sepatu" name="nama_sepatu" placeholder="Masukkan Judul Buku">
                    </div>
                    <div class="form-group">
